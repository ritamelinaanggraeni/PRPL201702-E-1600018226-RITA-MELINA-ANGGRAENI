...
if($konek->connect_error){
  die("Koneksi Gagal Karena : ". $konek->connect_error);
	...
	$select = mysqli_query($konek, "SELECT * FROM pesanan WHERE tanggal BETWEEN '$tanggalawal' and '$tanggalakhir' ");
	} 
	else{
  ...
  while ($row = $select->fetch_assoc()) {
    ...
    echo "<td><a href='delete_pesan.php?nomormeja=".$row['nomormeja']."'>Hapus</a></td>";
