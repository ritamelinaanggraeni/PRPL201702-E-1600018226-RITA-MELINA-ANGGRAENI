...
<table border ="0" width="1350px" margin="auto" style="background-color: #caedf8;">
<tr> 
    <td><h1><center>PESANAN</center></h1></td>
    <P></P>
  </tr>  
  <tr>
<td>
    <center>
        <P></P>
      <H1>Menu Tambah :</H1>
         <center><H1><li><a href="tambah_customer.php">TAMBAH CUSTOMER</a></li></H1></center>
      <H1>Menu Tampil : </H1>
        <center><H1><li><a href="tampil_customer.php">DAFTAR CUSTOMER YANG REGISTRASI</a></li></H1></center>
    </center>
</td>
</tr>
</table>
